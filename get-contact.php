...
set_time_limit(90);
	...
	curl_setopt($c, CURLOPT_USERAGENT, "curl from http://suda.co.uk/projects/microformats/ ");
	...
	if (isset($_GET['type'])){
		switch(strtolower($_GET['type'])){
		    case "rdf":     $extension .= "rdf"; $contentType = 'application/xml+rdf'; $filename = "/users/home/briansuda/web/public/projects/microformats/hcard/xhtml2vcardrdf.xsl"; break;
		    default:    $filename = '/users/home/briansuda/web/public/projects/microformats/hcard/xhtml2vcard.xsl'; $contentType = "text/x-vcard"; $extension = 'vcf'; break;
		}
	} else { $filename = '/users/home/briansuda/web/public/projects/microformats/hcard/xhtml2vcard.xsl'; $contentType = "text/x-vcard"; $extension = 'vcf';}
